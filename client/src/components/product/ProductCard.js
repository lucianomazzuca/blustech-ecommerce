...
const ProductCard = ({ model, price, brand, image, discount }) => {
  let imgSrc;
  ...
  return (
    <article className="product-card relative flex flex-col border-2 border-gray-200 rounded-lg overflow-hidden">
